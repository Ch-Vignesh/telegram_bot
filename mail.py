...
TWILIO_SID = os.getenv("TWILIO_ACCOUNT_SID", "AC3a4357f9bf101c9b5cab6d5aba6e4d72")
TWILIO_TOKEN = os.getenv("TWILIO_AUTH_TOKEN", "9694f249be5f194b0984e74d1f363016")
TWILIO_FROM = os.getenv("TWILIO_FROM_NUMBER", "+17854533802")
EMERGENCY_CONTACT = os.getenv("EMERGENCY_CONTACT", "+919182131811")
ELEVENLABS_API_KEY = os.getenv("ELEVENLABS_API_KEY", "sk_a01ce8f1b5ef94b8641fcbd5dfa7a27b42829db0919b5fe6")
ELEVENLABS_AGENT_ID = os.getenv("ELEVENLABS_AGENT_ID", "agent_9101k3fvwvvve3zt0m65md750a10")
ELEVENLABS_NUMBER_ID = os.getenv("ELEVENLABS_NUMBER_ID", "phnum_8901k3fw4h2resh8hpjfmme3tjqh")
